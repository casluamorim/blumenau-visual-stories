...
type AppRole = 'admin' | 'manager' | 'editor' | 'viewer' | 'financeiro' | 'social_media' | 'client' | 'fotografo' | 'gestor_anuncios' | 'designer' | 'motion_designer' | 'roteirista' | 'redator' | 'produtor';
